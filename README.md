...
| | Про що |
|---|---|
| [**prohin-sela.md**](materials/prohin-sela.md) | Як робиться одне село, від запиту читача до відкритого PR: схема з усіма ролями, воротами й петлями. 30-60 агентів, 1000-2000 запитів до моделі й 4-12 сторінок на село; жоден агент не перевіряє сам себе і жоден не публікує |
| [**dozbir.md**](materials/dozbir.md) | Друга половина роботи: що робити з уже опублікованим. Шість місць, де лежить борг, 10-15 розвідників по каналах одночасно, позитивний контроль перед кожним «порожньо», чотири перевірки знахідки, суд і внесення по селах |
...
| [**dzherela/**](dzherela/) | Бібліографія «Містка»: 563 джерела з архівними адресами й посиланнями, одним файлом |
